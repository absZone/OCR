...
the exam. It allows students to see or display his answers after the exam is finish.<p>
					...
					<div class="col-md-3 colorlib-widget">
						...
						<p>
							<ul class="colorlib-footer-links">
								...
								<li><a href="news.php"><i class="icon-check"></i> Newsfeed</a></li>
					...
					<div class="col-md-3 colorlib-widget">
						<h4>Contact Info</h4>
						<ul class="colorlib-footer-links">
							<li>Reena Mehta College, <br> Bhayander(w),Thane-401107.</li>
...
Copyright <script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made with <i class="icon-heart" aria-hidden="true"></i> by <a href=#" target="_blank">ABS</a>
