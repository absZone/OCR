				...
				<div class="row row-pb-md">
					...
					<div class="col-md-10 col-md-offset-1 text-center animate-box">
						<div class="about-wrap">
							...
							<p>The online classroom is actually developed to provide the simulation of classrooms in
...
collaborate, file sharing, directory sharing, audio/video input/output device sharing etc.</p>
				...
				<div class="row">
					<div class="col-md-4 animate-box">
						<p>Virtual education refers to instruction in a learning environment where
...
multimedia resources, the network audio/video conferencing .</p>
					...
					<div class="col-md-4 animate-box">
						<p>Students from all over the world can enroll in courses offered by any institution.
...
learning rather than passive reception.</p>
					...
					<div class="col-md-4 animate-box">
						<p>The aim of this project is to provide a web enabled interactive model of e-learning in
