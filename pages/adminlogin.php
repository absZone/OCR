...
<head>
    ...
    <title>ONLINE CLASSROOM | Admin Login</title>
    ...
    <div class="page-container">
                        ...
                        <div class="panel-body">
                            <form role="form" id="form6" method="post" class="validate">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Admin User ID</label>

                                    <input type="text" placeholder="Admin user id" name="loginId" id="loginId" class="form-control" >
                                </div>
                                <div class="form-group">
        ...
        $("#form6").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "../scripts/adminloginscript.php", // Your php script to wait for login connections and set login sessions
                        type: "POST",
