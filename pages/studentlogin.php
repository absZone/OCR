...
<head>
    ...
    <title>ONLINE CLASSROOM | Student Login</title>
    ...
    <div class="page-container">
                        ...
                        <div class="panel-body">
                            <form role="form" id="form7" method="post" class="validate">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Student user id" name="loginId" id="loginId" class="form-control" >
                                </div>
                                <div class="form-group">
        ...
        $("#form7").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "../scripts/studentloginscript.php", // Your php script to wait for login connections and set login sessions
                        type: "POST",
