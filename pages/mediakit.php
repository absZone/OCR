...
<head>
    ...
    <title>Online Classroom | MediaKit</title>
...
<body class="page-body" data-url="http://neon.dev">
  ...
  <div class="panel-body">
  	<form method="post" id="formf">
	    ...
	    <input type="text" name="heading" class="form-control" id="exampleInputEmail1" placeholder="Name">
      </div>
      <div class="form-group">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" name="posted" class="form-control" id="exampleInputEmail1" placeholder="Email">
	  </div>
...
if(isset($_POST) & !empty($_POST)){
	...
	$isql = "INSERT INTO mediakit (heading,content,posted) VALUES ('$heading', '$content', '$posted')";
	$ires = mysqli_query($con, $isql) or die(mysqli_error($con));
	if($ires){
    $smsg = "Your News Posted Successfully";
    echo $smsg;
	}else{
    $fmsg = "Failed to post";
    echo $fmsg;
