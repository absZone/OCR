    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <ol class="breadcrumb bc-3">
                ...
                <li class="active">
                    <a href="viewStudent.php">Courses</a>
                </li>
            </ol>
                        ...
                        <div class="panel-body">
                            ...
                            <script type="text/javascript">
                                function showViewModal(iD) {
                                    ...
                                    jQuery.ajax({
                                        ...
                                        success: function(data) {
                                            ...
                                            jQuery('#modal-view .modal-body #courseView').val(data.courseTypeId);
                                        }
                                    });
                                }
                                ...
                                function showEditModal(iD) {
                                    ...
                                    jQuery.ajax({
                                        url: "../scripts/viewstuScript.php", // Your php script to wait for login connections and set login sessions
                                        type: "POST",
                                        ...
                                        success: function(data) {
                                            ...
                                            jQuery('#modal-edit .modal-body #courseTypeId').val(data.courseTypeId);
                                        }
                                    });
                                }
                            </script>
                        ...
                        <div class="modal-body" style="padding:30px">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <select id="courseTypeId" name="courseTypeId" class="form-control">
