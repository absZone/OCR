...
<html lang="html5">
    ...
    <link rel="stylesheet" href="materials/css/login.css">
    ...
    <body>
    <form method="post" action="scripts/facultyloginscript.php">
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="email" name="loginEmail" id="loginEmail" maxlength="254" />
	...
	<div class="inputGroup inputGroup3">
		<button id="login">Log in as Faculty</button>
	</div>	
</form>
        ...
        <script src="materials/js/login.js"></script>
